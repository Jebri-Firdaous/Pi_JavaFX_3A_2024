...
// Gestion de la sélection dans le ComboBox pour le tri
            triComboBox.setOnAction(event -> {
                ...
                if (selectedOption != null) {
                    ...
                    //   afficherMessage("Erreur", "Erreur lors du tri des réservations : " + e.getMessage(), Alert.AlertType.ERROR);
            ...
            listeView.setOnMouseClicked(event -> {
                if (event.getClickCount() == 2) {
                    ...
                    if (selectedReservation != null) {
                        // Utilisez selectedReservation.getDate_reservation() pour obtenir la date de réservation
