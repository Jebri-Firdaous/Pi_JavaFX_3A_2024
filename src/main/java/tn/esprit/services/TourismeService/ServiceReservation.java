...
public class ServiceReservation implements IService<Reservation> {
    ...
    public void ajouter(Reservation reservation) throws SQLException {
        ...
        String sql = "INSERT INTO `reservation` (`duree_reservation`, `prix_reservation`, `date_reservation`, `id_hotel`, `type_chambre` , `id_personne` ) VALUES (?, ?, ?, ? , ? , ?)";
        ...
        preparedStatement.setInt(6, reservation.getId_personne());
        System.out.println(reservation.getId_personne());
