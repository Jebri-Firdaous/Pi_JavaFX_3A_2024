...
public class AfficherCommandeController implements ModificationListener {
    ...
    private void genererBonDeCommandePDF(Commande commande) {
        try {
            ...
            PDImageXObject image = PDImageXObject.createFromFile("C:\\Users\\lenovo\\IdeaProjects\\ProjetPidev\\src\\main\\resources\\logo.png", document);
...
// Entête de l'entreprise
            ...
            document.save("C:\\Users\\lenovo\\Desktop\\BonDeCommande"+commande.getId_Commande()+".pdf");
